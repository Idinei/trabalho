                ...
                <div class="span12"> 
                    <div class="navbar"> 
                        <div class="navbar-inner"> 
                            <div class="container"> 
                                <h2 class="center">Relatório de Lançamentos</h2> 
                            </div> 
                        </div> 
                    </div> 
                </div> 
            ...
            <div class="row-fluid"> 
                ...
                <div class="span12">
                    <div class="well">
                        ...
                        $this->table->set_heading('Código', 'Data', 'Conta_código', 'Tipo', 'Descrição', 'Valor', 'S_atualizado');
                        foreach ($lancamentos as $l) {                     
                            $data = implode('/', array_reverse(explode('-', $l->data)));
                            $this->table->add_row($l->codigo, $data, $l->conta_codigo, $l->tipo, $l->descricao, $l->valor, $l->at_lancamento);
                        }
                        ?>
                        <div id="menu">
